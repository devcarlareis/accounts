...
function operation(){
  ...
  .then((answer) => {
    ...
    if(action === "Criar conta"){
      ...
      console.log(chalk.bgBlue.black('Obrigada por usar Accounts'))
      process.exit()
    }
  })
...
function buildAccount(){
  inquirer.prompt([
    ...
    function(err){
      console.log('error ao criar conta',err)
    })
...
function addAmount(accountName, amount){
   ...
   fs.writeFile(`accounts/${accountName}.json`,
...
function removeAmount(accountName, amount){
  ...
  console.log(chalk.green(`foi realizado o saque de $${amount} na sua conta`))
